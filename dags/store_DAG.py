...
with DAG('store_dag',
    ...
    t4 = MySqlOperator(task_id='insert_mysql_table',
                       mysql_conn_id="mysql_conn",
    ...
    t6 = BashOperator(task_id='move_file1',
                      bash_command='cat ~/store_files_airflow/location_wise_profit.csv '
                                   '&& mv ~/store_files_airflow/location_wise_profit.csv '
                                   '~/store_files_airflow/location_wise_profit_%s.csv' % yesterday_date,
                      )

    t7 = BashOperator(task_id='move_file2',
                      bash_command='cat ~/store_files_airflow/store_wise_profit.csv '
                                   '&& mv ~/store_files_airflow/store_wise_profit.csv '
                                   '~/store_files_airflow/store_wise_profit_%s.csv' % yesterday_date,
                      )

    # t8 = EmailOperator(task_id='send_email',
    #                    to='uhh0701@gmail.com',
